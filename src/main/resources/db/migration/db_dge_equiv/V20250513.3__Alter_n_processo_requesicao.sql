-- 1. Exclua a view temporariamente
DROP VIEW IF EXISTS vw_requisicao;

-- 2. Altere o tipo da coluna
ALTER TABLE eqv_t_requisicao
ALTER COLUMN n_processo TYPE INTEGER USING n_processo::INTEGER;

-- 3. Recrie a view (substitua este SQL pelo seu CREATE VIEW original)
CREATE VIEW vw_requisicao AS
SELECT * FROM eqv_t_requisicao;
